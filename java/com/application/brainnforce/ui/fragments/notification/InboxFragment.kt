...
import com.application.brainnforce.databinding.FragInboxBinding
import com.application.brainnforce.databinding.InboxListBinding
...
class InboxFragment : BNFBaseFragment<FragInboxBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        { binder, model, position, itemView ->
            ...
            binder.linearSwipe.setOnClickListener {
