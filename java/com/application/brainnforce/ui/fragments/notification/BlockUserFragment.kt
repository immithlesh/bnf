...
class BlockUserFragment : BNFBaseFragment<FragBlockUsersBinding>() {

    private var mAdapter: RecyclerViewGenricAdapter<UserDetail, BlockItemListBinding>? =
        null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewDataBinding.toolbarTitle.text = getText(R.string.block_user)
        ...
        mAdapter = RecyclerViewGenricAdapter(list, R.layout.block_item_list)
    ...
    override fun getLayoutId(): Int {
        return R.layout.frag_block_users
    }
