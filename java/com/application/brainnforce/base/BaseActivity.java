...
import com.application.brainnforce.network.ApiClient;
...
public abstract class BaseActivity<T extends ViewDataBinding> extends AppCompatActivity implements BaseFragment.Callback, FragmentManager.OnBackStackChangedListener {
    ...
    public void showLoading() {
        hideLoading();
        mDialog = BNFCommon.Companion.setLoadingDialog(this);
    }
    ...
    public void onBackPressed() {
       /* FragmentManager localFragmentManager = getSupportFragmentManager();
        if (currentFragment.getParentFragmentManager().findFragmentByTag("com.application.brainnforce.ui.fragments.auth.LoginFragment")
                == localFragmentManager.findFragmentByTag("com.application.brainnforce.ui.fragments.auth.LoginFragment")) {
            finish();
        } else {*/
        onBackStackChanged();
        /*    }*/
